...
const Navbar = () => {
  return (
    <div className="  z-30 bg-white md:fixed md:left-0 md:right-0   flex justify-center  border-b-2 md:pt-4 pt-14 pb-4 ">
      {/* container */}
      <div className="py-3 w-10/12 flex flex-col gap-5  md:flex-row  justify-between text-xs  items-center sticky ">
        {/* leftbar */}
        ...
        <div className=" text-gray-600">
          <p>
            {" "}
            <span className="text-orange-600   text-sm md:text-xl ">
              Call Us:{" "}
            </span>{" "}
            <span className=" cursor-pointer text-sm md:text-lg">
              (+977) 9866448106
            </span>
          </p>
        </div>
