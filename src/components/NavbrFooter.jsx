...
const NavbrFooter = () => {
  return (
    <div   name="navbar"  className=" hidden md:flex   md:pt-36 md:pb-10 h-[120px] justify-center  items-center">
      {/* container */}
      <div className="   w-full md:w-10/12 flex justify-between ">
        ...
        <div className=" flex items-center gap-8">
          ...
          <p className=" ml-[-30px] hover:text-orange-600 cursor-pointer">$0.00</p>
        </div>
      </div>
    </div>
  );
