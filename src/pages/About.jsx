  ...
  return (
    <div className=" flex justify-center">
      <div className=" flex   w-full md:px-0 px-4  md:w-10/12 bg-gray-100">
        <div className=" md:flex flex-col gap-8 py-10 md:py-20">
          <div className=" flex-1  z-20">
            <img className=" cursor-pointer  rounded-xl md:absolute md:pl-[60px] md:mt-[-20px]  pb-8  " src={about} alt="" />
          </div>
