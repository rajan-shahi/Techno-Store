    ...
    <div className=" flex justify-center">
      <div className=" flex  w-full md:py-8  py-4 justify-center ">
        <div className=" flex flex-col  shadow-md shadow-slate-400 md:px-8 bg-gray-200  px-4 md:py-8 w-[400px]">
          ...
          />
          <span className=" font-bold text-white py-1 cursor-pointer">
            Last Name:
          </span>
          <input
            name="name"
            className=" p-2 rounded-full outline-orange-400 px-2  font-bold"
            type="text"
            placeholder=" Enter your last name ........"
          />
          <span className=" text-xl  text-white p-1 cursor-pointer">
            Subject:
          </span>
          <input
            name="subject"
            ...
            placeholder=" subject ............"
          />
          <span className=" text-xl text-white py-1 cursor-pointer">
            Message:
          </span>
          <textarea
          ...
          <div className=" py-4 text-right">
            <button className=" text-xl text-white bg-green-400 hover:bg-orange-400 w-max px-6 py-2 rounded-full cursor-pointer ">
              Submit
            </button>
          </div>
        </div>
