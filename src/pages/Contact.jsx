...
const Contact = () => {
  return (
    <div className=" flex justify-center">
      <div className=" flex  w-full md:py-8  py-4 justify-center bg-gray-300">
        <div className=" flex flex-col  shadow-md shadow-slate-400 md:px-8  px-4 md:py-8 w-[400px]">
          ...
          <button className=" text-xl text-white bg-green-400 hover:bg-orange-400 w-max px-6 py-2 rounded-full cursor-pointer ">Submit</button>
          </div>
        </div>
      </div>
    </div>
